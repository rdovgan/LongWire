<div id="userPanel">
    ...
    <ul class="nav nav-pills nav-stacked">
        ...
        <li id="envelopeItem"><a href="#"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>Messages</a></li>
        <li id="thumbItem"><a href="#"><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>People</a></li>
        <li id="calendarItem"><a href="#"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Calendar</a></li>
